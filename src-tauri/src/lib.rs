...
use crate::commands::exercises::{
    ...
    get_exercise_category, get_exercise_graph_data, get_exercise_history, get_last_set,
    get_last_workout_exercise, get_rep_maxes, list_exercise_categories, list_exercises_in_category,
...
use crate::commands::templates::{
    add_exercise_to_template, create_template, delete_template_set, get_sets_for_template_exercise,
    get_template, get_template_exercise_context, merge_template_exercises,
    remove_exercise_from_template, reorder_template_exercises, reorder_template_sets,
    upsert_template_set,
};
use crate::commands::templates::{
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_rep_maxes,
            get_sets_for_template_exercise,
            get_sets_for_workout_exercise,
            get_settings,
            get_template,
            get_template_exercise_context,
